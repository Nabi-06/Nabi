    ...
    <div className="bg-white rounded-md p-7">
      ...
      <div className="flex gap-x-6 text-[13px] mb-10">
        <div className="flex gap-x-3 items-center">
          <img src="/icons/mapPinIcon.png" className="object-cover w-5" />
          <p>{recruit.region}</p>
        </div>
        <div className="flex gap-x-3 items-center">
          <img src="/icons/calendarIcon.png" className="object-cover w-5" />
          <p>{dayjs(recruit.volunteeringDate).format("YYYY-DD-MM")}</p>
        </div>
        <div className="flex gap-x-3 items-center">
          <img src="/icons/usersIcon.png" className="object-cover w-5" />
          <p>
      ...
      <div className="flex gap-x-6 text-[13px] mb-5">
        <div className="flex gap-x-3 items-center">
          <img src="/icons/messageIcon.png" className="object-cover w-5" />
